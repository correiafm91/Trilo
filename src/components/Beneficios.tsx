  ...
  <section className="w-full max-w-5xl mx-auto py-16 px-4 bg-black">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {beneficios.map((b, i) => (
        <div
          key={b.titulo}
          className="bg-gray-900 border border-gray-700 rounded-3xl p-8 flex flex-col items-center shadow-xl transition-transform duration-300 group hover:scale-105 hover:shadow-2xl animate-fade-in backdrop-blur-sm"
